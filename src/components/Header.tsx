...
export function Header() {
  ...
  return (
    <>
      <header className="mt-8 w-full text-foreground px-4 pt-2 flex justify-between mb-2 items-center">
        <div className="flex gap-4 items-baseline">
          <Tabs defaultValue="connect">
            <TabsList className="bg-transparent border-0">
              <TabsTrigger className=" " value="connect">
                <Link to="/">
                  {lang === "pt-br" ? "Conexão" : "Connection"}
                </Link>
              </TabsTrigger>
              <TabsTrigger className="" value="readings">
                <Link to="/readings">
                  {lang === "pt-br" ? "Leituras" : "Readings"}
                </Link>
              </TabsTrigger>
            ...
            <SelectGroup>
              <SelectItem value="pt-br">
                <div className="flex gap-2 items-center">
                  <img src={BrFlag} alt="Brazil Flag" className="h-3" />{" "}
                  <p className="text-xs">Pt-Br</p>
                </div>
              </SelectItem>
              <SelectItem value="en-us">
                <div className="flex gap-2 items-center">
                  <img src={UsaFlag} alt="USA Flag" className="h-3" />{" "}
                  <p className="text-xs">En-US</p>
                </div>
              </SelectItem>
            </SelectGroup>
          </SelectContent>
